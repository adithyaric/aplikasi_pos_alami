                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="kas_id" data-placeholder="Pilih Kas"
                                    ...
                                    @foreach ($kas as $k)
                                        <option value="{{ $k->id }}"
                                            {{ old('kas_id', $pengeluaran->kas_id) == $k->id ? 'selected' : '' }}>
                                            {{ $k->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="jumlah"
                                    value="{{ old('jumlah', $pengeluaran->jumlah) }}" placeholder="Masukkan Jumlah">
                                @error('jumlah')
                                    <div class="invalid-feedback text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="desc"
                                    value="{{ old('desc', $pengeluaran->desc) }}" placeholder="Masukkan Deskripsi">
                                @error('desc')
                                    <div class="invalid-feedback text-danger">
                                        {{ $message }}
                                    </div>
