            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Canvas</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ route('canvases.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="termin_days" value="{{ old('termin_days') }}"
                                            min="0" placeholder="0">
                                        @error('termin_days')
                                            <div class="invalid-feedback text-danger">
                                                {{ $message }}
