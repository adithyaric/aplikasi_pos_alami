            ...
            <div class="box box-primary">
                ...
                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row box-body">
                        ...
                        <!-- Satuan Terbesar (Konversi) -->
                        <div class="col-md-12 form-group">
                            <label for="">Satuan Terbesar </label>
                            <input type="text" class="form-control" name="satuan_terbesar"
                                value="{{ old('satuan_terbesar') }}" placeholder="ball / karung">
                            @error('satuan_terbesar')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="">Isi Konversi Terbesar<small class="text-danger"> (Contoh: 1 ball = 10 slop)</small></label>
                            <input type="text" class="form-control integer-only-input" name="konversi_qty_terbesar"
                                value="{{ old('konversi_qty_terbesar') }}" inputmode="numeric"
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" class="form-control" name="satuan_besar"
                                value="{{ old('satuan_besar') }}" placeholder="slop / karton / box">
                            @error('satuan_besar')
                            <div class="invalid-feedback text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" class="form-control" name="satuan"
                                value="{{ old('satuan', $product->satuan ?? '') }}" placeholder="Contoh: Pack, Pcs, Box">
                            @error('satuan')
                            <div class="invalid-feedback text-danger">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-12 form-group">
                            <label for="">Isi Konversi <small class="text-danger">(Contoh: 1 slop = 10 pack)</small></label>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" class="form-control rupiah-input" name="harga_beli" value="{{ old('harga_beli', 0) }}"
