...
Route::middleware(['role:admin-gudang|admin-cabang|staff-outlet|owner|sales|superadmin'])->group(function () {
    ...
    Route::get('/customer-penjualan/options', [SalesCustomerController::class, 'options'])->name('customer-penjualan.options');
    Route::get('/customer-penjualan', [SalesCustomerController::class, 'index'])->name('customer-penjualan.index');
    Route::get('/customer-penjualan/create', [SalesCustomerController::class, 'create'])->name('customer-penjualan.create');
    Route::post('/customer-penjualan', [SalesCustomerController::class, 'store'])->name('customer-penjualan.store');
    Route::get('/customer-penjualan/{type}/{id}/edit', [SalesCustomerController::class, 'edit'])->name('customer-penjualan.edit');
